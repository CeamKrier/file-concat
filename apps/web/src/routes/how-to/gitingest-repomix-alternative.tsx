...
export const Route = createFileRoute("/how-to/gitingest-repomix-alternative")({
  ...
  head: () => ({
    meta: [
      ...generateSEOMeta({
        ...
        url: "https://fileconcat.com/how-to/gitingest-repomix-alternative",
      }),
      {
        name: "keywords",
        content:
    ...
    links: [
      { rel: "canonical", href: "https://fileconcat.com/how-to/gitingest-repomix-alternative" },
    ],
