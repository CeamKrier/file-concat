  ...
  return (
    ...
    >
      <div className="min-w-0">
        ...
        >
          Your people&rsquo;s data never leaves your computer.
        </h2>
        <p className="text-ink-secondary mt-4 max-w-[48ch] text-[15px] leading-relaxed">
          ...
          server first. FileConcat does the reading in this browser tab. Nothing is sent, nothing is
          stored, and there is no account to create. Open your own network panel and watch: after
          the page loads, working through a folder sends zero requests.
        </p>
