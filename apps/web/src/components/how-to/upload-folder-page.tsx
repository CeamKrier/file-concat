...
const STEPS = [
  ...
  },
  {
    ...
    body: "PDFs, Word, Excel, and notes become text in this tab, with the token count shown as it goes. Nothing is uploaded.",
  },
  {
    title: "Upload the one file",
    body: "Attach the single file to your chat or Project. ChatGPT reads it as text, with no archive to open.",
  },
];
        ...
        <MockWindow label="client-handover.txt" trailing={<UploadChip />}>
          <pre className="overflow-x-auto px-4 py-4 font-mono text-[12.5px] leading-[1.7]">
            <code>
              ...
              <span className="text-go-fg">{`"client-handover"`}</span>
