...
| `--parse [formats]`       |       |                            | Extract text from PDF, DOCX, XLSX, PPTX, ODT, ODS, ODP, RTF. Comma list or empty for all. |
...
## Binary documents (PDF, DOCX, XLSX, PPTX, ODT, ODS, ODP, RTF)
...
code. Available formats: PDF, DOCX, XLSX, PPTX, ODT, ODS, ODP, RTF.
