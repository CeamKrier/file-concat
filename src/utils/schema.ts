export const generateArticleSchema = () => {
    return {
        ...
        description: "Learn how to use FileConcat, the free online tool for combining multiple files into AI-optimized formats for ChatGPT, Claude, Gemini, and other large language models.",
        ...
        keywords: ["file concatenation", "AI tools", "ChatGPT", "Claude", "LLM", "developer tools", "code sharing"],
        inLanguage: "en-US"
    };
};
...
export const generateHowToSchema = () => {
    return {
        ...
        description: "Step-by-step guide on using FileConcat to prepare multiple files for AI language models like ChatGPT and Claude.",
        image: "https://fileconcat.com/opengraph.png",
        totalTime: "PT2M",
        estimatedCost: {
            "@type": "MonetaryAmount",
